...
void loop()
{
  ...
  if (power_difference < 0)
    OrangutanMotors::setSpeeds((maximum  / 2) + (power_difference * 1.5), maximum);
    //                              0                    60
  else
    OrangutanMotors::setSpeeds(maximum, (maximum / 2) - (power_difference * 1.5));
/*
    if (power_difference < 0) //Turn Left
    OrangutanMotors::setSpeeds((maximum / 2) + power_difference, maximum / 2);
  else //Turn Right
    OrangutanMotors::setSpeeds(maximum / 2, (maximum / 2) - power_difference);
    */
}
